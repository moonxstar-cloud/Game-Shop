...
function Home({ searchQuery }) {
  ...
  const filteredGames = searchQuery
    ...
    : data?.results; // If no search query, show all games



 // Determine if pagination should be shown
const shouldShowPagination = searchQuery
  ? filteredGames?.length > pageSize // For search results, check filtered games
  : data?.count > pageSize; // For all games, check the total count from the API
